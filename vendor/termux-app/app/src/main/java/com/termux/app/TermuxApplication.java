...
public class TermuxApplication extends Application {
    ...
    public void onCreate() {
        ...
        initializeTermux(this);
    }

    /** Initialize Termux from ChatKJB's combined Application without replacing it. */
    public static void initializeTermux(Application application) {
