...
public class RunCommandService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        */
        ...
        // Do not accept file-based result configuration until allow-external-apps has been
        // authorized. Otherwise a caller with RUN_COMMAND permission could overwrite files in
        // Termux home, prefix, or external storage through a client-controlled result format.
